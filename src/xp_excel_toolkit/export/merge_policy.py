"""Merge-write conflict handling for export.

Solves the silent-loss case where multiple cells in a single merged
range receive disagreeing intended values during export. xp_excel_toolkit
provides the *mechanism* (detect + policy resolvers); the caller picks
the *policy*.
"""
